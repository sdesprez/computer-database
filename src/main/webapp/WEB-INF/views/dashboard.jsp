...
<jsp:include page="includes/header.jsp" />
	...
	<footer class="navbar-fixed-bottom">
		<div class="container text-center">
			<ul class="pagination">
				<li><a href="dashboard?page=${page.pageNumber-1}" aria-label="Previous"> <span
				...
				<li><a href="#">4</a></li>
				<li><a href="#">5</a></li>
				<li><a href="dashboard?page=${page.pageNumber+1}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
				</a></li>
			</ul>
